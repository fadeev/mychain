...
export { MsgUpdatePool, MsgCreatePool, MsgDeletePool };
...
export const txClient = ({ signer, prefix, addr }: TxClientOptions = { addr: "http://localhost:26657", prefix: "cosmos" }) => {
  ...
  return {
		...
		msgUpdatePool({ value }: msgUpdatePoolParams): EncodeObject {
			try {
				return { typeUrl: "/mychain.dex.MsgUpdatePool", value: MsgUpdatePool.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgCreatePool({ value }: msgCreatePoolParams): EncodeObject {
			try {
				return { typeUrl: "/mychain.dex.MsgCreatePool", value: MsgCreatePool.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgDeletePool({ value }: msgDeletePoolParams): EncodeObject {
			try {
				return { typeUrl: "/mychain.dex.MsgDeletePool", value: MsgDeletePool.fromPartial( value ) }  
			} catch (e: any) {
