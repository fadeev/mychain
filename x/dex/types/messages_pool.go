...
func NewMsgCreatePool(creator string, amount sdk.Coins, desc string, height int32) *MsgCreatePool {
...
func NewMsgUpdatePool(creator string, id uint64, amount sdk.Coins, desc string, height int32) *MsgUpdatePool {
