...
func New(
	...
	*/
	...
	app.MychainKeeper = *mychainmodulekeeper.NewKeeper(
		appCodec,
		keys[mychainmoduletypes.StoreKey],
		keys[mychainmoduletypes.MemStoreKey],
		app.GetSubspace(mychainmoduletypes.ModuleName),
	)
